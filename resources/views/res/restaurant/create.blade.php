                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content pt-1">
                                    <div class="tab-pane active" id="restaurant-info" role="tabpanel" aria-labelledby="restaurant-info-tab-justified">
                                        ...
                                        <form method="POST" action="{{ route('restaurants.store') }}"  class="restaurant-info-form">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="row g-1 pt-1">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input required name="phone" value="{{ old('phone') }}" type="tel" class="form-control dt-input" data-column="4" placeholder="" data-column-index="3"/>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    @include('inc.image-upload',['field' => 'cover_img','id' => 'cover_img'])
                                                </div>
