        ...
        <div class="row">
            <div class="col-md-9">
                <h5 class="mt-1 text-capitalize">
                    <i data-feather="shuffle"></i> &nbsp; <img style="width: 30px" src="{{ $menu->img }}" /> {{ $menu->name }}
                </h5>
            </div>
        ...
        @endforeach
            ...
            @foreach($item->categories as $item)
                <div class="row">
                    ...
                    <div class="col-md-3 mt-1 mb-1 accordion-buttons">
                        <a type="button" class="btn btn-primary blue-bg waves-effect waves-float waves-light" data-bs-toggle="modal" data-bs-target="#editMenuItemModal{{ $item->id }}">
                            <i data-feather="edit"></i>
                        </a>
                        ...
                        <a type="button" class="btn btn-primary red-bg waves-effect waves-float waves-light" data-bs-toggle="modal" data-bs-target="#deleteSubCat{{$item->id}}">
                            <i data-feather="trash-2"></i>
                        </a>
                        {{--                @include('inc.modals.deletes.menu_item')--}}
                        @include('inc.modals.deletes.menu_sub_cat')
