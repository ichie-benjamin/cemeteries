                                        ...
                                        <form method="POST" action="{{ route('cemeteries.update', $cemetery->id) }}"   class="cemetery-info-form">
                                            ...
                                            <div class="row g-1 pt-1">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input  value="{{ old('municipalities', $cemetery->municipalities) }}" name="municipalities" type="text" class="form-control dt-input" data-column="4" placeholder="" data-column-index="3"/>
